...
SECRET_KEY = 'django-insecure-uu+7!_dd2xbaz&xs(r6hq+)q_6z66h)g4()4mf*j1ivg11c6(s'
...
INSTALLED_APPS = [
    ...
    'fpages',
    'advert_table.apps.AdvertTableConfig',
    'pers_acc',
    'django_apscheduler',
    'ckeditor',
    'ckeditor_uploader'
...
# ACCOUNT_FORMS = {'signup': 'advert_table.forms.BasicSignupForm'}
